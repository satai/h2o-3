...
def glm_alpha_array_lambda_null():
    ...
    for l in range(0,len(rVal['lambdas'])):       
        ...
        pyunit_utils.assertEqualCoeffDicts(csVal, mVal.coef())
        pyunit_utils.assertEqualCoeffDicts(cs_normVal, mVal.coef_norm())
        ...
        pyunit_utils.assertEqualRegPaths(regKeys, rVal, l, mrVal)
