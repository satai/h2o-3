...
def glm_alpha_lambda_arrays():
    ...
    startValInit = [0,0,0,0,0,0,0,-0.3945120960889672]
    ...
    for l in range(0,len(r['lambdas'])):
        ...
        assert abs(devm - devn) < 1e-5
        pyunit_utils.assertEqualRegPaths(regKeys, r, l, mr, tol=1e-5) # check all values from regPaths
